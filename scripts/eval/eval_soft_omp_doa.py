...
def main():
    ...
    ap.add_argument('--angles', type=int, nargs='*', required=True, help='Angles to evaluate (must exactly match in H and dataset)')
    ...
    # Subset H to requested angles (exact match, no nearest)
