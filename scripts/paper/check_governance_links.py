...
STRING_CHECKS = [
    ...
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "sentence-energy pass"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "local architecture pass"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "full architecture pass"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "old-world belief"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "Results section jobs"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "discovery cash-out section"),
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "for any paper-facing explanation round"),
    ...
    (REPO_ROOT / "docs/agent-ops/README.md", "Old-world belief"),
    (REPO_ROOT / "docs/agent-ops/README.md", "Paper protagonist"),
    (REPO_ROOT / "docs/agent-ops/README.md", "Paper spine map"),
    (REPO_ROOT / "docs/agent-ops/README.md", "Tool role"),
    (REPO_ROOT / "docs/agent-ops/README.md", "Reference-object role"),
    (REPO_ROOT / "docs/agent-ops/README.md", "Worldview-shift sentence"),
    (REPO_ROOT / "docs/agent-ops/README.md", "drafting-time bundle"),
    ...
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Old-world belief"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Paper protagonist"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Paper spine map"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Results section jobs"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Discovery-vs-tool weight budget"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Redundancy / breathing risks"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Worldview-shift sentence"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Sentence-friction hotspots"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Causal glue to add"),
    (REPO_ROOT / "docs/agent-ops/TASK_PACKETS.md", "Diction to normalize"),
    ...
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "old-world belief"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "paper protagonist"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "Results section jobs"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "`Architecture evidence map:`"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "any paper-facing explanation round"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "paper-facing explanation packets outside the main manuscript"),
