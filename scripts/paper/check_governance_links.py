...
STRING_CHECKS = [
    ...
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "In Plan mode, both direct and delegated work must remain non-mutating and plan-safe."),
    ...
    (REPO_ROOT / "docs/agent-ops/SUPERVISOR_OPERATING_MODEL.md", "SV#"),
    ...
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "editor readout sentence"),
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "SV#"),
    ...
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "Keep direct and delegated work non-mutating and plan-safe until execution mode."),
    ...
    (REPO_ROOT / ".codex" / "skills" / "agent-orchestrator" / "SKILL.md", "## Delegation decision"),
