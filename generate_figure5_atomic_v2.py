#!/usr/bin/env python3
"""
Generate Figure 5 Atomic Panels (Nature Style) - v2
Consistent Color Scales and Directory Structure
"""
import numpy as np
...
def create_atomic_panels_b(routing_data, dict_data, out_dir):
    ...
    vmin_qk = -vmax_qk
    cmap_qk = 'RdBu_r' # Consistent with correlation plots (Red=High/Pos, Blue=Low/Neg)
...
def main():
    ...
    # New output directory structure: nature-figures/results/results_figure5_v2
    out_dir = Path("results/results_figure5_v2")
    out_dir.mkdir(exist_ok=True, parents=True)
    
    print("="*60)
    print("Generating Figure 5 Atomic Panels (Nature Style) - v2")
    print("="*60)
