...
Open and follow: `docs/fig5_b3_band_decomposition_spec.md`
...
Implement exactly as in `docs/fig5_b3_band_decomposition_spec.md`:
...
All items in `docs/fig5_b3_band_decomposition_spec.md` **Acceptance checklist** must pass, especially:
