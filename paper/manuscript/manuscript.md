...
f, Family alignment to that neighborhood. Bars summarize which decoder families keep support local while preserving the neighborhood's angle-by-angle shape. Open circles show a weaker full-matrix comparison as a secondary reference.
