#!/usr/bin/env python3
"""
Generate Figure 5 Atomic Panels (Nature Style) - v4
Refined Aesthetics: Serif fonts, Professional Color Palette, Improved Polar Plot (Right Half Only)
"""
import numpy as np
...
def create_atomic_panels_b(routing_data, dict_data, out_dir):
    ...
    # B3: Polar Plot - REFINED V4 (Right Half Only)
    ...
    # Since 0 is North and direction is clockwise (-1), 
    # 0 to 180 covers the right hemisphere (N -> E -> S).
    ax.set_thetamin(0)
    ax.set_thetamax(180)
...
def main():
    ...
    # New output directory structure: nature-figures/results/results_figure5_v4
    out_dir = Path("results/results_figure5_v4")
    out_dir.mkdir(exist_ok=True, parents=True)
    
    print("="*60)
    print("Generating Figure 5 Atomic Panels (Nature Style) - v4")
    print("="*60)
