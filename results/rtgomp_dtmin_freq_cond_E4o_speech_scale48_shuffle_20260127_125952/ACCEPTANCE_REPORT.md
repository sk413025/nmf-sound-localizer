...
- Run: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/
...
- code_state.json: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/code_state.json
...
- Pairing mode: paired
- Subset manifest: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/subset_manifest.json
...
MPLCONFIGDIR=/tmp/mpl PYTHONPATH=. conda run --no-capture-output -n trl-training python -u scripts/h_exploration/run_rtgomp_e4h_paper_eval.py \
  ...
  --freq_cond_mode shuffle --freq_cond_seed 0 --freq_cond_constant_idx 200
```
...
- k_selected_mean list = [15.90702040413023, 15.502445531347265, 14.105108443258732, 12.867224939479275, 12.097228397806433]

Compute-matched capture summary (DT/OMP/Random):
- lambda_c=1e-05: k_mean=15.907, DT=0.9992, OMP=0.9998, Random=0.9983, DT-Random=0.0008
- lambda_c=3e-05: k_mean=15.502, DT=0.9989, OMP=0.9998, Random=0.9974, DT-Random=0.0015
- lambda_c=1e-04: k_mean=14.105, DT=0.9970, OMP=0.9994, Random=0.9909, DT-Random=0.0060
- lambda_c=2e-04: k_mean=12.867, DT=0.9935, OMP=0.9986, Random=0.9793, DT-Random=0.0141
- lambda_c=3e-04: k_mean=12.097, DT=0.9900, OMP=0.9978, Random=0.9681, DT-Random=0.0220
...
- Target lambda_c=3e-4: DT_cm(normal)=0.9945, DT_cm(this)=0.9900, Δ=0.0045
- Classification (suite-level): FREQ_COND_IGNORED
...
3) Verification:
- Confirm files exist:
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/summary/compute_matched_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/summary/rtg_controllability_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/summary/freq_cond_audit_summary.json
- Confirm no wav/fs guardrail failures in results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_shuffle_20260127_125952/run.log
