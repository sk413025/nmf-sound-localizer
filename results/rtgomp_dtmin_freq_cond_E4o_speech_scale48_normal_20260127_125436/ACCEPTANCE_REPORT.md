...
- Run: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/
...
- code_state.json: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/code_state.json
...
- Pairing mode: paired
- Subset manifest: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/subset_manifest.json
...
- k_selected_mean list = [15.901252408477841, 15.436947285213181, 13.96239069215948, 12.733819969369103, 11.947618694728522]

Compute-matched capture summary (DT/OMP/Random):
- lambda_c=1e-05: k_mean=15.901, DT=0.9992, OMP=0.9998, Random=0.9983, DT-Random=0.0009
- lambda_c=3e-05: k_mean=15.437, DT=0.9991, OMP=0.9998, Random=0.9972, DT-Random=0.0019
- lambda_c=1e-04: k_mean=13.962, DT=0.9983, OMP=0.9996, Random=0.9898, DT-Random=0.0086
- lambda_c=2e-04: k_mean=12.734, DT=0.9966, OMP=0.9992, Random=0.9773, DT-Random=0.0193
- lambda_c=3e-04: k_mean=11.948, DT=0.9945, OMP=0.9988, Random=0.9653, DT-Random=0.0293

### 4.2 Suite-level classification (required)

- This is the reference (normal) run used for deltas.
- Classification (suite-level): FREQ_COND_IGNORED
...
3) Verification:
- Confirm files exist:
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/summary/compute_matched_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/summary/rtg_controllability_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/summary/freq_cond_audit_summary.json
- Confirm no wav/fs guardrail failures in results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_normal_20260127_125436/run.log
