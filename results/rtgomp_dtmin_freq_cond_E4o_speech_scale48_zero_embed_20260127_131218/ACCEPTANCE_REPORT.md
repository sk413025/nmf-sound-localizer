...
- Run: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/
- Mode: scale_check_subset
- Pairing mode: paired
- freq_cond_mode: zero_embed
- freq_cond_seed: 0
...
- code_state.json: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/code_state.json
...
- Pairing mode: paired
- Subset manifest: results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/subset_manifest.json
...
MPLCONFIGDIR=/tmp/mpl PYTHONPATH=. conda run --no-capture-output -n trl-training python -u scripts/h_exploration/run_rtgomp_e4h_paper_eval.py \
  ...
  --freq_cond_mode zero_embed --freq_cond_seed 0 --freq_cond_constant_idx 200
```
...
- k_selected_mean list = [15.998468455115853, 15.858171533027024, 14.388864186552048, 13.119102317079196, 12.316399881428783]

Compute-matched capture summary (DT/OMP/Random):
- lambda_c=1e-05: k_mean=15.998, DT=0.9992, OMP=0.9999, Random=0.9985, DT-Random=0.0007
- lambda_c=3e-05: k_mean=15.858, DT=0.9991, OMP=0.9998, Random=0.9983, DT-Random=0.0008
- lambda_c=1e-04: k_mean=14.389, DT=0.9984, OMP=0.9997, Random=0.9959, DT-Random=0.0025
- lambda_c=2e-04: k_mean=13.119, DT=0.9970, OMP=0.9993, Random=0.9902, DT-Random=0.0068
- lambda_c=3e-04: k_mean=12.316, DT=0.9951, OMP=0.9989, Random=0.9831, DT-Random=0.0120
...
- Target lambda_c=3e-4: DT_cm(normal)=0.9945, DT_cm(this)=0.9951, Δ=-0.0006
- Classification (suite-level): FREQ_COND_IGNORED
...
3) Verification:
- Confirm files exist:
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/summary/compute_matched_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/summary/rtg_controllability_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/summary/freq_cond_audit_summary.json
- Confirm no wav/fs guardrail failures in results/rtgomp_dtmin_freq_cond_E4o_speech_scale48_zero_embed_20260127_131218/run.log
