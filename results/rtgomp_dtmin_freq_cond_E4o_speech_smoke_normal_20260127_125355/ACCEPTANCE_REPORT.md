...
- Run: results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/
- Mode: smoke
- Pairing mode: paired
...
- code_state.json: results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/code_state.json
...
- Pairing mode: paired
- Subset manifest: results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/subset_manifest.json
  - num_pairs = 1 (expected 416 for full dataset)
...
- k_selected_mean list = [15.9, 15.429479768786127, 13.99942196531792, 12.747398843930636, 11.976300578034682]

Compute-matched capture summary (DT/OMP/Random):
- lambda_c=1e-05: k_mean=15.900, DT=0.9993, OMP=0.9998, Random=0.9984, DT-Random=0.0009
- lambda_c=3e-05: k_mean=15.429, DT=0.9992, OMP=0.9998, Random=0.9969, DT-Random=0.0023
- lambda_c=1e-04: k_mean=13.999, DT=0.9983, OMP=0.9996, Random=0.9883, DT-Random=0.0100
- lambda_c=2e-04: k_mean=12.747, DT=0.9967, OMP=0.9992, Random=0.9740, DT-Random=0.0226
- lambda_c=3e-04: k_mean=11.976, DT=0.9942, OMP=0.9987, Random=0.9593, DT-Random=0.0348

### 4.2 Suite-level classification (required)

- Smoke run (not used for suite deltas).
- Classification (suite-level): FREQ_COND_IGNORED
...
3) Verification:
- Confirm files exist:
  - results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/summary/compute_matched_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/summary/rtg_controllability_summary.json
  - results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/summary/freq_cond_audit_summary.json
- Confirm no wav/fs guardrail failures in results/rtgomp_dtmin_freq_cond_E4o_speech_smoke_normal_20260127_125355/run.log
