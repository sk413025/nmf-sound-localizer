...
## Figure 3 — Solver Dynamics (4 panels)
...
│  Row 2 — 47.8 mm                                     │  │
│  ┌─────────────────────┬─────────────────────┐       │  │
│  │(d) Pairwise matrix  │(e) Confidence hist  │       │  │
...
│  │┌──────┬─────┐│┌────────────┐│              │      │  │
│  ││d1:BL │d2:NT│││e1: @55°    ││  single plot │      │  │
│  ││CM    │ CM  │││42.4 × 28.6 ││  42.4 × 67.3│      │  │
│  ││18.9× │18.9×││├────────────┤│              │      │  │ 67.3 mm
│  ││67.3  │67.3 │││gap 10.0 mm ││              │      │  │
│  ││      │     ││├────────────┤│              │      │  │
│  ││      │     │││e2: @100°   ││              │      │  │
│  ││      │     │││42.4 × 28.6 ││              │      │  │
│  │└──────┴─────┘│└────────────┘│              │      │  │
...
Sub-panel detail:
  ...
  Panel (d) — inner GridSpec 1×2, wspace=0.30
  ┌─────────┬─────────┐
  │ d1: BL  │ d2: NT  │  sub_w = 42.4 / (2+0.30) = 18.4 mm
  │ CM      │ CM      │  gap = 0.30 × 18.4 = 5.5 mm
  │18.4×67.3│18.4×67.3│  full height used
  └─────────┴─────────┘
...
| Panel (d) sub-panels  | **18.4 × 67.3 mm** each, gap 5.5mm  |
