...
- keep bidirectional no-translation traceability explicit: a reader should be able to move from `Introduction/Results` into `Methods` and from `Methods/Supplementary` back into the paper-facing argument while recognizing the same scientific actors without building a second term dictionary
